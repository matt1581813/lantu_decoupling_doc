...
* 1 .概论：
  本文档主要帮助需要适配澜图的地图引擎了解澜图数据、服务管理结构与重要接口、以便适配。
  GIS 服务解耦层通过标准化数据源、数据集、渲染样式与服务接口，统一封装底层多种 GIS 引擎与空间数据系统，屏蔽不同引擎的数据模型、样式表达与服务协议差异，为上层应用提供一致、稳定的空间服务访问能力，实现异构 GIS 能力的融合与透明化使用。
  ![1762327363076](images/解耦层设计/1762327363076.png)
* 2 .数据与服务架构
  ...
  ![1762327379270](images/解耦层设计/1762327379270.png)
* 3 .运行模式与接口简介：
...
* 3.3矢量地图服务：
  ...
  ![1762327435523](images/解耦层设计/1762327435523.png)
...
* 3.4影像地图服务：
  ...
  ![1762327460953](images/解耦层设计/1762327460953.png)
